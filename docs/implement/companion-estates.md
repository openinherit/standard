...
> **Status: Draft / Proposed design.** Some fields described here (for example `ownershipCategory`) are proposed and not yet part of the v3 schema. This document describes intended design, not shipped behaviour.
