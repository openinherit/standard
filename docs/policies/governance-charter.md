...
| Item | Status |
|------|--------|
| **Governance phase** | Phase 1 (Stewardship) |
| **INHERIT version** | v5.0.0 |
| **Steering committee** | Forming — TT permanent seat filled |
| **Jurisdiction tech partners** | 8 seed partners identified across 8 jurisdictions (not yet formally signed) |
| **Institutional endorsements** | 0 (outreach planned) |
| **Transition conditions met** | No |
