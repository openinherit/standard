...
Relative value of each jurisdiction extension for kinship enrichment:

| Extension | Value |
|-----------|-------|
| UK England & Wales | HIGH |
| Hong Kong | HIGH |
| US Estate | HIGH |
| Scotland | MEDIUM |
| Ireland | MEDIUM |
| Canada | MEDIUM |
| EU Succession | MEDIUM |
| Switzerland | LOW |
| India | LOW |
| UAE | LOW |
...
All findings derive from cross-jurisdictional kinship research conducted in
April 2026, tracked in issue #42.
